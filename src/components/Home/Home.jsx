            ...
            <div className={styles.home}>
                ...
                <Card title="Hi.">
                    <p className={text_styles.p2}>I'm Tan Juay Hee, an aspiring
                        game
                        developer.</p>
                    <p>This is my portfolio and homepage for my works, or works
                        that
                        I've been involved in.</p>
                    <p> Use the navigation panel on the left to explore. </p>
                </Card>
                <Button className={styles.button} route='' linkText='JP'/>
            </div>
        </div>
    )
}
